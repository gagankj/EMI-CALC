...
class LoanCalculator:
    ...
    def __init__(self):
        ...
        window.title("EMI Calculator")  # Set title
        # create the input boxes.
        Label(window, text="Rate of Interest(p.a.)").grid(row=1,column=1, sticky=W)
        Label(window, text="Loan Tenure (Years)").grid(row=2,column=1, sticky=W)
        Label(window, text="Loan Amount").grid(row=3,column=1, sticky=W)
        Label(window, text="Monthly EMI").grid(row=4,column=1, sticky=W)
